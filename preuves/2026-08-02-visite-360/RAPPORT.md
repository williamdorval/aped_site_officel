...
| clavier-droite | 61.0 | la piece est la |
| glissement-souris | 52.8 | la piece est la |
...
| de | vers | ecart |
|---|---|---|
| affiche | chargement | 61.12 % |
| chargement | vivante-terrasse | 0.00 % |
| vivante-terrasse | clavier-droite | 72.78 % |
| clavier-droite | glissement-souris | 73.46 % |
...
- **ok** — la fleche fait tourner la piece (le passage se deplace de 400 px)
- **ok** — le glissement fait tourner la piece (le passage se deplace de 4216 px)
