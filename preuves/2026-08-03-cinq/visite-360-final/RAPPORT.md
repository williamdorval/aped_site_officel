...
Ecart-type de luminance dans la fenetre de la scene (1046 x 589 px). Sous 8, la surface est perimee : la capture ne porte pas le panorama.

| image | ecart-type | verdict |
|---|---|---|
| affiche | 58.5 | la piece est la |
| chargement | 62.4 | la piece est la |
| vivante-terrasse | 62.4 | la piece est la |
| clavier-droite | 60.4 | la piece est la |
| glissement-souris | 53.2 | la piece est la |
| piece-salon | 59.1 | la piece est la |
| piece-par-passage | 66.2 | la piece est la |
...
| de | vers | ecart |
|---|---|---|
| affiche | chargement | 61.10 % |
| chargement | vivante-terrasse | 0.00 % |
| vivante-terrasse | clavier-droite | 72.71 % |
| clavier-droite | glissement-souris | 73.26 % |
...
- **ok** — la fleche fait tourner la piece (le passage se deplace de 465 px)
- **ok** — le glissement fait tourner la piece (le passage se deplace de 11794 px)
- **ok** — le plan change de piece
- **ok** — le salon a deux passages, la terrasse un
- **ok** — un passage dans l'image change de piece

- erreurs console : **0**
- images : 7, paires au-dessus de 1 % d'ecart : 5
