...
| ~~A79b~~ | ~~`ba-defile`~~ | **SUPPRIMÉE le 2026-07-31 (D-628).** La boucle existait pour montrer ce qu'une fenêtre fixe ne pouvait pas montrer. Le cadre est devenu un petit écran dans lequel le visiteur descend lui-même, à son rythme, des deux côtés à la fois : sa main fait mieux que la boucle, et c'est **une animation permanente de moins** au budget des paliers. | — | — | — | — | — | — |
| ~~A79c~~ | ~~`ap-rail`~~ | **SUPPRIMÉE le 2026-07-30 (D-617)** avec les quatre maquettes « après », remplacées par des captures des vrais sites. L'entrée avait survécu à la coupe. | — | — | — | — | — | — |
| ~~A79d~~ | ~~`ap-souder`~~ | **SUPPRIMÉE le 2026-07-30 (D-617)**, même raison qu'A79c. | — | — | — | — | — | — |
