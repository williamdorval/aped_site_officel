...
|---|---|---|---|---:|---|---|---|
| 01 | **Accueil** | `#top` | 250-308 | 59 | 2176-2439 · 1655-1930 | `main.js` 370-475 | — |
| 02 | **Services** | `#services` | 309-927 | 619 | 2440-3088 | `main.js` 476-875 | — |
| 03 | **Réalisations** | `#realisations` | 928-1828 | 901 | 3089-4910 | `main.js` 876-1122 | — |
| 04 | **Secteurs** | `#demos` | 1829-2041 | 213 | 4911-5064 | `main.js` 4935-5151 · `langue.js` 524-612 | `css/secteurs.css` (entier, injecte par JS) |
| 05 | **Visite 360** | `#visite` | 2042-2121 | 80 | — | — | `css/tour360.css` · `js/tour360.js` (entiers) |
| 06 | **Calculateur** | `#calculateur` | 2122-2279 | 158 | 5065-5231 | `main.js` 4768-4934 | — |
| 07 | **Comparatif** | `#comparatif` | 2280-2402 | 123 | 5232-5358 | — | — |
| 08 | **Processus** | `#processus` | 2403-2631 | 229 | 5359-5701 | `main.js` 1123-1163 | — |
| 09 | **Référence** | `#reference` | 2632-2801 | 170 | 5702-5851 · 5852-6055 | — | — |
| 10 | **Questions** | `#faq` | 2802-2916 | 115 | 6223-6272 | `langue.js` 613-641 | — |
| 11 | **Contact** | `#contact` | 2917-3135 | 219 | 6273-6490 | `main.js` 1769-1802 · `main.js` 2147-2325 · `main.js` 2725-2826 | — |
| — | **Pied de page** | `#footer` | 3136-3195 | 60 | 6491-6562 | `main.js` 5621-5641 | — |
