...
| **Formes** | **Rayon 0, aucune ombre, aucun dégradé, aucun flou, aucune transparence** — non par obéissance à l'interdit d'ADEXWEB, qui ne s'applique pas ici, mais parce que la matière de cet écran est **l'aplat**. Une bande est un rectangle plein ; un rayon en ferait une étiquette. Deux épaisseurs de trait et pas trois : **1 px brun** pour les séparations du registre, **10 px sable clair** pour la lisière du volet — la seule ligne qui bouge |
