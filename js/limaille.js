/* == LIMAILLE — moteur de champ de grains ==  D-526 */
...
(function (root) {
  ...
  function Limaille(canvas, opt) {
    ...
    this.dead = false;
    try {
      /* LE CONTEXTE EST ALPHA, ET C'EST UNE CORRECTION DE BOGUE.  D-527 */
    ...
    this.o = {
      ...
      /* Ressort critiquement amorti. omega est la pulsation propre  D-528 */
      omegaRest: opt.omegaRest === undefined ? 21 : opt.omegaRest,
      omegaStart: opt.omegaStart === undefined ? 7 : opt.omegaStart,
      /* Dissipation supplementaire appliquee a la vitesse. Forte au  D-529 */
      ...
      /* Repulsion. ATTENTION A L'ECHELLE : a l'equilibre le  D-530 */
  ...
  Limaille.prototype.setColors = function (bgHex, massHex, inkHex) {
    ...
    /* Fond TRANSPARENT : c'est la surface de la page qui se voit, donc  D-531 */
    this.bg = 0;
  ...
  Limaille.prototype.compose = function (draw, bands, xform) {
    ...
    /* La COUVERTURE, c'est (grain / pas) au carre. A pas 2 et grain  D-533 */
    ...
    /* La composition est echantillonnee DROITE, ce qui garde des  D-534 */
    for (var i = 0; i < n; i++) {
      var tx = xs[i], ty = ys[i];
  ...
  /* Position de depart AVANT le deploiement.  D-535 */
  ...
  Limaille.prototype.setRepelRadius = function (capHeightCss) {
    /* Calibre sur la hauteur de capitale du PETIT mot. A 0,55 le  D-536 */
  ...
  /* Integration semi-implicite, ressort critiquement amorti.  D-537 */
