...
| 4 | **Le seuil de contraste était mesuré sur 52 % du texte, par un outil incapable d'échouer** | *(ce commit)* | Sonde indépendante : **389 éléments contre 747**, 47,9 % jamais mesurés. Après réparation : 740 mesurés à 1440 clair, toujours **0 échec**. Contraste dégradé volontairement → sortie **1** en nommant `p.hero-sub` à 1,07 ; retiré → sortie 0, `index.html` identique à HEAD |
